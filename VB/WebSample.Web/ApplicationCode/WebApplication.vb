...
Namespace WebSample.Web
	Partial Public Class WebSampleAspNetApplication
		Inherits WebApplication
		Private module1 As DevExpress.ExpressApp.SystemModule.SystemModule
		Private module2 As DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule
		Private module3 As WebSample.Module.WebSampleModule
		Private module4 As WebSample.Module.Web.WebSampleAspNetModule
		...
		Private Sub WebSampleAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
		...
		Private Sub InitializeComponent()
			...
			Me.module3 = New WebSample.Module.WebSampleModule()
			Me.module4 = New WebSample.Module.Web.WebSampleAspNetModule()
			...
			' sqlConnection1
			' 
			Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=WebSample;Integrated Security=SSPI;Pooling=false"
			Me.sqlConnection1.FireInfoMessageEventOnUserErrors = False
			' 
			' WebSampleAspNetApplication
			' 
			Me.ApplicationName = "WebSample"
...
'			Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.WebSampleAspNetApplication_DatabaseVersionMismatch);
